...
MI_measures["Percent_Bias"][1,1] <- NA
knitr::kable(round(MI_measures, 3), align = "ccccc") %>% kable_styling() %>% kable_styling(full_width = F)
...
LD_measures["Percent_Bias"][1,1] <- NA

knitr::kable(round(LD_measures, 3), align = "ccccc") %>% kable_styling() %>% kable_styling(full_width = F)
...
colnames(mean_times) <- "avg-runtime"
mean_times
knitr::kable(mean_times) %>% kable_styling(full_width = F)

```
```{r}
samp_data <- data_mis[99:103, ]
knitr::kable(samp_data) %>% kable_styling(full_width = F)
